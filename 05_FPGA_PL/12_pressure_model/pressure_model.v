...
//-----------------------------------------------------------------------------
// pressure_model.v   2026-08-03 新建
// 仿真压力源 (植物模型): 在真实气压传感器缺席/调试期间顶替它,
// 根据泵/阀的实际输出推算气室理论压力, 使 FSM/显示/安全联锁全流程可演示。
//
// 模型规则 (与 glove_fsm 输出约定一致):
//   valve_i=0 (阀开, RELEASE/IDLE/EMERGENCY): 快速泄气 DEC_X100KPA_PER_S
//   valve_i=1 且 pump_i=1 (阀闭+泵开, GRIP):  充气 INC_X100KPA_PER_S
//   valve_i=1 且 pump_i=0 (阀闭保压, HOLD):   缓慢泄漏 LEAK_X100KPA_PER_S
...
module pressure_model #(
    ...
    /* Q8 定点压力 (0.01kPa × 256), 每 1ms 加/减一次 */
    ...
    assign pressure_o = p_q8[23:8];   /* 去小数位, 输出 0.01kPa 整数 */
